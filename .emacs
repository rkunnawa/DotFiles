...
(set-register ?m (cons 'file "/ssh:rkunnawa@cgate.cmsaf.mit.edu|hidsk0001:~/"))
(set-register ?c (cons 'file "/ssh:rkunnawa@lxplus.cern.ch:~/"))
(set-register ?r (cons 'file "/ssh:raghav@physsun.rutgers.edu:~/"))
